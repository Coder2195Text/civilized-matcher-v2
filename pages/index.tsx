      ...
      {status == "unauthenticated" && (
        <div className="w-full text-center">
          ...
          <div>
            ...
            <br /> Well, if you are already a member of my discord server, that
            great matchmaking is HERE. <br /> Our matchmaking is secure, because
            you cannot fake someone else's application due to our Discord OAuth.
            Try it out now!!!
          </div>
